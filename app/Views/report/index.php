<?php
// ============================================================
// VIEW — app/Views/report/index.php
// ============================================================
/**
 * Biến nhận từ ReportController::index():
 * @var array  $summary     ['income', 'expense', 'balance']
 * @var string $chartJson   JSON string cho Chart.js
 * @var int    $month       Tháng đang xem
 * @var int    $year        Năm đang xem
...
$extraCss  = BASE_URL . '/css/report.css';
...
(function () {
    ...
    // ── Biểu đồ xu hướng (Bar) ──────────────────────────────
    const barCtx = document.getElementById('trendChart');
    if (barCtx) {
        new Chart(barCtx, {
            type: 'bar',
            data: data.trend,
    ...
    // ── Biểu đồ tỷ trọng chi tiêu (Donut) ────────────────────
    const donutCtx = document.getElementById('catChart');
    if (donutCtx) {
