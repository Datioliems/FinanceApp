...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-sm-6 col-lg-3">
        ...
        <div class="card border-0 h-100" style="background:<?= $balPositive ? '#eff6ff' : '#fef2f2' ?>">
            <div class="card-body">
                <div class="small text-muted mb-1">
                    <i class="bi bi-wallet2 me-1 <?= $balPositive ? 'text-primary' : 'text-danger' ?>"></i>Số dư
                </div>
        ...
        <div class="row g-2 align-items-end">
            ...
            <div class="col-6 col-sm-auto">
                ...
                <select name="category_id" class="form-select form-select-sm">
                    ...
                    <option value="<?= (int)$c['id'] ?>" data-type="<?= $c['type'] ?>" <?= ($catFilter ?? 0) === (int)$c['id'] ? 'selected' : '' ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const filterCat = document.querySelector('select[name="category_id"]');
    if (filterType && filterCat) {
        const catOptions = Array.from(filterCat.querySelectorAll('option[data-type]'));
        ...
        function updateCats() {
            ...
            if (!hasSelected && filterCat.value !== '0') {
                filterCat.value = '0';
            }
        }
        
        filterType.addEventListener('change', updateCats);
